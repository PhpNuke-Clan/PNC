...
if ($getAdmin['radminsuper'] == 1) {
  switch ($op) {
    ...
    case 'ABAuthScan':include('admin/modules/nukesentinel/ABAuthScan.php');break;
    ...
    case 'ABHarvesterAddSave':include('admin/modules/nukesentinel/ABHarvesterAddSave.php');break;
    case 'ABHarvesterDelete':include('admin/modules/nukesentinel/ABHarvesterDelete.php');break;
    case 'ABHarvesterDeleteSave':include('admin/modules/nukesentinel/ABHarvesterDeleteSave.php');break;
    case 'ABHarvesterEdit':include('admin/modules/nukesentinel/ABHarvesterEdit.php');break;
    case 'ABHarvesterEditSave':include('admin/modules/nukesentinel/ABHarvesterEditSave.php');break;
    ...
    case 'ABRefererAddSave':include('admin/modules/nukesentinel/ABRefererAddSave.php');break;
    case 'ABRefererDelete':include('admin/modules/nukesentinel/ABRefererDelete.php');break;
    case 'ABRefererDeleteSave':include('admin/modules/nukesentinel/ABRefererDeleteSave.php');break;
    case 'ABRefererEdit':include('admin/modules/nukesentinel/ABRefererEdit.php');break;
    case 'ABRefererEditSave':include('admin/modules/nukesentinel/ABRefererEditSave.php');break;
    ...
    case 'ABStringAddSave':include('admin/modules/nukesentinel/ABStringAddSave.php');break;
    case 'ABStringDelete':include('admin/modules/nukesentinel/ABStringDelete.php');break;
    case 'ABStringDeleteSave':include('admin/modules/nukesentinel/ABStringDeleteSave.php');break;
    case 'ABStringEdit':include('admin/modules/nukesentinel/ABStringEdit.php');break;
    case 'ABStringEditSave':include('admin/modules/nukesentinel/ABStringEditSave.php');break;
    ...
    case 'ABTrackedAgentsListAddSave':include('admin/modules/nukesentinel/ABTrackedAgentsListAddSave.php');break;
    ...
    case 'ABTrackedRefersListAddSave':include('admin/modules/nukesentinel/ABTrackedRefersListAddSave.php');break;
    ...
    case 'ABTrackedUsersDelete':include('admin/modules/nukesentinel/ABTrackedUsersDelete.php');break;
