...
echo "</td></tr></table>";
	...
	."<br><div align=\"center\"><a href=\"http://marcoledingue.free.fr/modules.php?name=Content&amp;pa=list_pages_categories&amp;cid=1\" style=\"FONT-SIZE:16px\" target=\"_blank\"><strong>FAQ</strong></a><br><br>version 2.1.2 - &copy; <a href=\"mailto:marcoledingue@free.fr?body=Read the FAQ before asking me questions!!\">marcoledingue</a></div>";
...
function edit() {
	...
	if ($sommaireeditposted!="ok") {
		if ($catimage<>"noimg" && !eregi(".swf",$catimage)) {
			if ($z!='imacategory') {
