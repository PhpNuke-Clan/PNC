...
$pnpadmerr = intval($row['displayerror']);
    ...
    echo "<br>";
	    OpenTable();
    echo "<center><font class='option'><b>" . _PNP_ADM_OPT . "</b></font></center>"
	."<table border='0'><tr><td>"
	."" . _PNP_ADM_ERR . "</td><td>";
    if ($pnpadmerr==1) {
