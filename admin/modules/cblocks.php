...
function CBMenu() {
    ...
    OpenTable();
    echo "<center>";
	echo "<a href='".$admin_file.".php'>"._CB_BACKADMIN."</a><br>\n";
...
switch($op) {
    ...
    case "CenterBlocksSet1":
        ...
        echo "<td align='center'><b>"._CB_BLOCK."</b></td>\n";
        echo "<td align='center'><b>"._CB_TITLE."</b></td>\n";
        echo "<td align='center'><b>"._CB_FILENAME."</b></td>\n";
        echo "<td align='center'><b>"._CB_CONTENT."</b></td>\n";
        echo "<td align='center'><b>"._CB_SPEC."</b></td>\n";
        echo "<td align='center'><b>"._CB_WID."</b></td>\n";
        echo "</tr>\n";
