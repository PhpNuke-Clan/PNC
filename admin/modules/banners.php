...
/* Banners List */
	...
	echo "<td bgcolor=\"$bgcolor2\" align=center><a href=\"$imageurl\" target=\"new\">$name</a></td>"
	    ...
	    ."<td bgcolor=\"$bgcolor2\" align=center>[ <a href=\"".$admin_file.".php?op=BannerEdit&amp;bid=$bid\">" . _EDIT . "</a> | <a href=\"".$admin_file.".php?op=BannerStatus&amp;bid=$bid&status=$active\">$c_active</a> | <a href=\"".$admin_file.".php?op=BannerDelete&amp;bid=$bid&amp;ok=0\">" . _DELETE . "</a> ]</td><tr>";
    }
    echo "</td></tr></table><br>"
...
/* Clients List */
	...
	echo "<td bgcolor=\"$bgcolor2\" align=\"center\">$name</td>"
	    ...
	    ."<td bgcolor=\"$bgcolor2\" align=\"center\" nowrap>&nbsp;[ <a href=\"".$admin_file.".php?op=BannerClientEdit&amp;cid=$cid\">" . _EDIT . "</a> | <a href=\"".$admin_file.".php?op=BannerClientDelete&amp;cid=$cid\">" . _DELETE . "</a> ]&nbsp;</td><tr>";
    }
    echo "</td></tr></table>";
    CloseTable();
    echo "<br>";
