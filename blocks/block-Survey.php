...
global $mode,$prefix, $multilingual, $currentlang, $db, $boxTitle, $pollcomm, $user, $cookie,$HTTP_COOKIE_VARS, $sum;
...
//			   $percent3=sprintf(" %.1f%% ", $percent);
	...
	$content .= "<br>Vote again in:<br><b>$revote_main $string</b><br>";
