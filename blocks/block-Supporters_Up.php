...
$supporterup = $db->sql_fetchrow($db->sql_query("SELECT * from ".$prefix."_nsnsp_config"));
...
if ($supporterup['require_user'] == 0 || is_user($user)) { $content .= "[ <a href='modules.php?name=Supporters&amp;file=submit'>"._BESUPPORTER."</a> ]<br>\n"; }
