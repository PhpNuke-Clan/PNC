...
$content = "<center>Supported by<br><br>";
    ...
    while (list($site_id, $site_name, $site_image) = $db->sql_fetchrow($result)) {
        $content.= "<a href=\"modules.php?name=Supporters&op=go&site_id=$site_id\" target=\"_blank\"><img src=\"$site_image\" height=\"31\" width=\"88\" title=\"$site_name\" border=\"0\"></a><br><br>\n";
    }
$content .="</center>\n";
if ($supporterrn['require_user'] == 0 || is_user($user)) { $content .= "[ <a href='modules.php?name=Supporters&amp;file=submit'>"._BESUPPORTER."</a> ]<br>\n"; }
