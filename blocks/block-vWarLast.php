...
if(ini_get('allow_url_fopen') == 1){
	ob_start();
	include("$nukeurl/modules/$vwar_modulename/extra/lastactions.php");
...
if (!isset($vwarnm)) {
$content .= "<A HREF='javascript:PopupCentrer(\"blocks/copyright/vwar_last.html\",400,300,\"menubar=no,scrollbars=no,statusbar=no\")'><div align=\"right\">&copy;</div></A>\n"; 
}
//-----------COPYRIGHT END------------->
?>
