...
for (j=0;j<6+1;j++){
  ...
  codehex = r + '' + g + '' + b;
  document.write('		<td bgColor=\"' + RGB2Hexa(r,g,b) + '\" onClick=\"insertTag(this.bgColor);lightCase(this);\" onmouseover=\"lightCase1(this);\" title=\"'+text1+ RGB2Hexa(r,g,b) + ']'+text2+'color]\" width=\"'+w+'\" height=\"'+h+'\"><IMG height='+h+' src="modules/Forums/templates/subSilver/images/spacer.gif" width='+w+' border=0></TD>\n');
	}}}
