...
$lang['Welcome_phpBB'] = 'Welcome to PNC phpBB';
$lang['Admin_intro'] = 'Thank you for choosing PNC and phpBB as your forum solution. This screen will give you a quick overview of all the various statistics of your board. You can get back to this page by clicking on the <u>Admin Index</u> link in the left pane. To return to the index of your board, click the PNC logo also in the left pane. The other links on the left hand side of this screen will allow you to control every aspect of your forum experience. Each screen will have instructions on how to use the tools.';
...
$lang['Backup_explain'] = 'Here you can back up all your phpBB-related data. If you have any additional custom tables in the same database with PNCphpBB that you would like to back up as well, please enter their names, separated by commas, in the Additional Tables textbox below. If your server supports it you may also gzip-compress the file to reduce its size before download.';
...
$lang['Script_path_explain'] = 'The path where PNCphpBB is located relative to the domain name';
...
$lang['Smilies_path_explain'] = 'Path under your PNCphpBB root dir, e.g. images/smiles';
...
$lang['Avatar_storage_path_explain'] = 'Path under your PNCphpBB root dir, e.g. images/avatars';
$lang['Avatar_gallery_path'] = 'Avatar Gallery Path';
$lang['Avatar_gallery_path_explain'] = 'Path under your PNCphpBB root dir for pre-loaded images, e.g. images/avatars/gallery';
...
$lang['Rank_image'] = 'Rank Image (Relative to PNCphpBB root path)';
...
// Install Process
//
$lang['Welcome_install'] = 'Welcome to PNCphpBB  Installation';
...
$lang['Re_install'] = 'Your previous installation is still active.<br /><br />If you would like to re-install PNCphpBB you should click the Yes button below. Please be aware that doing so will destroy all existing data and no backups will be made! The administrator username and password you have used to login in to the board will be re-created after the re-installation and no other settings will be retained.<br /><br />Think carefully before pressing Yes!';

$lang['Inst_Step_0'] = 'Thank you for choosing PNCphpBB . In order to complete this install please fill out the details requested below. Please note that the database you install into should already exist. If you are installing to a database that uses ODBC, e.g. MS Access you should first create a DSN for it before proceeding.';
...
$lang['Inst_Step_2'] = 'Your admin username has been created.  At this point your basic installation is complete. You will now be taken to a screen which will allow you to administer your new installation. Please be sure to check the General Configuration details and make any required changes. Thank you for choosing PNCphpBB.';
...
$lang['ftp_instructs'] = 'You have chosen to FTP the file to the account containing PNCphpBB  automatically.  Please enter the information below to facilitate this process. Note that the FTP path should be the exact path via FTP to your phpBB2 installation as if you were FTPing to it using any normal client.';
...
$lang['Install_No_PCRE'] = 'PNCphpBB Requires the Perl-Compatible Regular Expressions Module for PHP which your PHP configuration doesn\'t appear to support!';

//
// Version Check
//
$lang['Version_up_to_date'] = 'Your installation is up to date, no updates are available for your version of PNCphpBB.';
$lang['Version_not_up_to_date'] = 'Your installation does <b>not</b> seem to be up to date. Updates are available for your version of PNCphpBB, please visit <a href="http://www.ultimateclansystem.com" target="_new">http://www.ultimateclansystem.com</a> to obtain the latest version of <b>PNCphpBB</b> (the ported version of phpBB files for PNC).';
$lang['Latest_version_info'] = 'The latest available version is <b>PNCphpBB %s</b>.';
$lang['Current_version_info'] = 'You are running <b>PNCphpBB %s</b>.';
$lang['Connect_socket_error'] = 'Unable to open connection to phpBB Server, reported error is:<br />%s';
$lang['Socket_functions_disabled'] = 'Unable to use socket functions.';
$lang['Mailing_list_subscribe_reminder'] = 'For the latest information on updates to PNCphpBB, why not <a href="http://www.ultimateclansystem.com" target="_new">subscribe to our mailing list</a>.';
