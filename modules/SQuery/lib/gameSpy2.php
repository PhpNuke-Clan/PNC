...
class gameSpy2 extends gsQuery
{
  ...
  function _processServerInfo($rawdata)
  {
	...
	$this->rules[$temp[$i]] = $temp[++$i];
     ...
     if(eregi("battlefield2", $this->gameserver->gamename2)) {
      $this->gameserver->gamename2="TDM";
    }  
    if(!$this->gamename) {
...
$retval="<table cellspacing=0 cellpadding=0 width=\"100%\">"
  ...
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">VOIP:</font></td><td>".($gameserver ->rules["bf2_voip"]?"Yes":"No")."</td></tr>"
  ...
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Global Unlocks:</font></td><td>".($gameserver ->rules["bf2_globalunlocks"]?"Yes":"No")."</td></tr>"
  . "		</table>"
  . "		</td>"
  . "		<td class=\"row\">"
  . "		<table cellspacing=0 cellpadding=0>"
...
$retval="<table cellspacing=0 cellpadding=0 width=\"100%\">"
  ...
  . "		<td class=\"row\">"
  . "		<table cellspacing=0 cellpadding=0>"
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">$this->gamename Soldier FF:</font></td><td>".$gameserver ->rules["soldier_friendly_fire"]."</td></tr>"
