 ...
 * @version $Id: gameSpy.php,v 1.17 2004/05/24 15:22:06 jr Exp $
...
// AVP fix	
    $this->gamename="Alien vs Predator 2";
    $this->gamename = $data["gamename"];
	if(eregi("Alien vs Predator 2", $this->gamename)) $this->gamename="Alien vs Predator 2";	
// SWAT 4 fix	
    $this->gamename="swat 4";
    $this->gamename = $data["gamename"];
	if(eregi("swat 4", $this->gamename)) $this->gamename="swat 4";	
// MOHAA fix
 if(eregi("mohaa", $this->gamename)) {
      $this->gamename="mohaa";
    }
// MOHAA fix
 if(eregi("Alien vs Predator 2", $this->gamename)) {
      $this->gamename="Alien vs Predator 2";
    }
...
*/
    ...
    // fix for AAO FIX BY SOLOKNIGHT WWW.TRUST-COMPANY.NET
    if(eregi("AAGP_GAMETEAMOBJECTIVE", $this->gametype)) {
      $this->gametype="TDM";
    } 
/*
    if(eregi("AAGP_GAMETEAM", $this->gametype)) {
      $this->gametype="TM";
    }
	if(eregi("AAGP_GAMEDEATHMATCH", $this->gametype)) {
      $this->gametype="DM";
    }
*/
    if(!$this->gametype) {
  ...
  function _processPlayers($rawPlayerData) 
  {
	...
	$chk=$this->gamename;
	if ($chk=="ut2"||$chk=="ut2004"||$chk=="ut"||$chk=="chaser"||$chk=="descent3"||$chk=="tacops"||$chk=="unreal" || $chk=="redorchestra" || $chk=="swat 4" || $chk=="graw" ||$chk=="avp2") {
...
. "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Ticket Ratio:</font></td><td>".$gameserver ->rules["ticket_ratio"]."</td></tr>"
  ...
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Respawn delay:</font></td><td>".$gameserver ->rules["respawnrate"]."</td></tr>"
 . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Difficulty:</font></td><td>".$gameserver ->rules["difficulty"]."</td></tr>"
  ...
  . "		<td class=\"row\">"
  . "		<table cellspacing=0 cellpadding=0>"
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">3rd Person:</font></td><td>".($gameserver ->rules["no3rd"] == "1" ? "Yes" : "No")."</td></tr>"
  ...
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Games Per Map:</font></td><td>".$gameserver ->rules["numberofgamespermap"]."</td></tr>"
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Number of Teams:</font></td><td>".$gameserver->rules["numteams"]."</td></tr>"
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Auto Balance Teams:</font></td><td>".($gameserver ->rules["autobalanceteams"] == "1" ? "Yes" : "No")."</td></tr>"
  . "		<tr><td style=\"padding-right: 5px;\">".checkmark()." <font class=\"color\">Show Names:</font></td><td>".($gameserver ->rules["shownames"] == "1" ? "Yes" : "No")."</td></tr>"
