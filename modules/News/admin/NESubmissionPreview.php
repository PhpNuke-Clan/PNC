...
$thetext = $hometext;
if(!empty($bodytext)) { $thetext .= "<br /><br />".$bodytext; }
$thetext = stripslashes($thetext);
$datetime = date("D M d, Y g:i a");
OpenTable();
themeindex($aid, $author, $datetime, $subject, 0, $topic, $thetext, $notes, $morelink, $tinfo['topicname'], $tinfo['topicimage'], $tinfo['topictext']);
echo "<br />\n";
echo "<form action='".$admin_file.".php' method='post'>\n";
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<tr><td bgcolor='$bgcolor2'><b>"._NE_NAME."</b></td><td><input type='text' name='author' size='25' value='$author'>\n";
if($author != $anonymous) {
  ...
  echo "&nbsp;&nbsp;[ <a href='mailto:$email?Subject=Re: $subject'>"._NE_EMAILUSER."</a> | <a href='modules.php?name=Your_Account&op=userinfo&username=$author'>"._NE_USERPROFILE."</a> | <a href='modules.php?name=Private_Messages&amp;mode=post&amp;u=$uid'>"._NE_SENDAPM."</a> ]\n";
}
echo "</td></tr>\n";
...
if(is_array($assotop)) { $associated = implode("-", $assotop); }
