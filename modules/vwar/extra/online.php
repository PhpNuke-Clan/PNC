...
else
{
	...
	?>
	<tr>
		<td align="left" width="70%">&raquo; <a href="modules.php?name=<?php echo $vwarmod; ?>&file=member&action=profile&memberid=<?php echo $row['memberid']; ?>"><?php echo $row['name']; ?></a></td>
