...
define("_DL_DIRECTIONS","<b>DIRECTIONS:</b>");
define("_DL_DLNOTES1","To download the file \"<b>");
define("_DL_DLNOTES2","</b>\", you need to retype the displayed passcode, and click the button below. In a few moments you will receive the download dialog or you will be directed to the appropriate site.");
