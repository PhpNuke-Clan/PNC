...
// menelaos: shows top table (differently for new users and current members)
  ...
  echo "<img src=\"modules/$module_name/images/warning.png\" align=\"left\" width=\"40\" height=\"40\"><center>"._YATOSINTRO1."</center>\n";
  } else {
  echo "<img src=\"modules/$module_name/images/warning.png\" align=\"left\" width=\"40\" height=\"40\"><center>"._YATOSINTRO2."</center>\n";
  }
  CloseTable();
  echo "<br>";
...
// menelaos: shows bottom table (differently for new users and current members)
  ...
  echo "<P><input type=\"submit\" value='"._YA_GOBACK."'>\n";
        ...
        echo "<center>"._YATOS3."</center><br>\n";
        echo "</td><tr><td align=\"middle\">";
        echo "<input type=\"radio\" name=\"tos_yes\" value='1' $sel2>"._YES."<br>\n";
        echo "<input type=\"radio\" name=\"tos_yes\" value='0' $sel1>"._NO."&nbsp&nbsp<br>\n";
        echo "<br><input type=\"submit\" value='"._YA_CONTINUE."'></tr>\n";
  }
  echo "</td></form></tr>";
  echo "</table>";
  CloseTable();
