...
function dss_rand()
{
    ...
    $add_user_sig = check_html($add_user_sig, 'nocheck');
	$add_user_sig_bbcode_uid = make_bbcode_uid();
	$add_user_sig = bbencode_first_pass($add_user_sig, $add_user_sig_bbcode_uid); 
    ...
    if ($stop == "") {
        ...
        $sql .= ") ";
        $sql .= "VALUES ('$new_uid', '$add_name', '$add_uname', '$add_email', '$add_femail', '$add_url', '$user_regdate', '$add_user_icq', '$add_user_aim', '$add_user_yim', '$add_user_msnm', '$add_user_from', '$add_user_occ', '$add_user_intrest', '$add_user_viewemail', 'gallery/blank.gif', '3', '$add_user_sig', '$add_user_sig_bbcode_uid', '$add_pass', '$add_newsletter', '1', '0'";
