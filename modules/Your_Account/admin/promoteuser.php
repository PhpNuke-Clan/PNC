...
//if   ($Version_Num >= 7.5)  { 
    ...
    echo "<tr><td bgcolor='$bgcolor2'>"._NAME.":</td><td colspan='3'><input type='text' name='add_name' size='30' maxlength='50' value='$rname'> <font class='tiny'>"._REQUIREDNOCHANGE."</font></td></tr>";
    echo "<tr><td bgcolor='$bgcolor2'>"._NICKNAME.":</td><td colspan='3'><input type='text' name='add_aid' size='30' maxlength='30' value='$uname'> <font class='tiny'>"._REQUIRED."</font></td></tr>";
    echo "<tr><td bgcolor='$bgcolor2'>"._EMAIL.":</td><td colspan='3'><input type='text' name='add_email' size='30' maxlength='60' value='$email'> <font class='tiny'>"._REQUIRED."</font></td></tr>";
...
/*}elseif($Version_Num == 7.4)  { 
 OpenTable();
    echo "<center><font class=\"option\"><b>" . _SURE2PROMOTE . "</b></font></center>"
	."<form action=\"modules.php?name=$module_name&file=admin\" method=\"post\">"
	."<table border=\"0\">"
	."<tr><td>" . _NAME . ":</td>"
	."<td colspan=\"3\"><input type=\"text\" name=\"add_name\" size=\"30\" maxlength=\"50\" value='$rname'> <font class=\"tiny\">" . _REQUIREDNOCHANGE . "</font></td></tr>"
	."<tr><td>" . _NICKNAME . ":</td>"
	."<td colspan=\"3\"><input type=\"text\" name=\"add_aid\" size=\"30\" maxlength=\"30\" value='$uname'> <font class=\"tiny\">" . _REQUIRED . "</font></td></tr>"
	."<tr><td>" . _EMAIL . ":</td>"
	."<td colspan=\"3\"><input type=\"text\" name=\"add_email\" size=\"30\" maxlength=\"60\" value='$email'> <font class=\"tiny\">" . _REQUIRED . "</font></td></tr>"
	."<tr><td>" . _URL . ":</td>"
