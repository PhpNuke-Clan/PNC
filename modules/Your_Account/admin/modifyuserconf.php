...
function dss_rand()
{
	...
	$chng_user_sig = check_html($chng_user_sig, 'nocheck');
	$chng_user_sig_bbcode_uid = make_bbcode_uid();
	$chng_user_sig = bbencode_first_pass($chng_user_sig, $chng_user_sig_bbcode_uid);    
	$chng_newsletter = intval($chng_newsletter);

	if ($stop == "") {
        if ($chng_pass != "") {
            $cpass = md5($chng_pass);
            $db->sql_query("UPDATE ".$user_prefix."_users SET username='$chng_uname', name='$chng_name', user_email='$chng_email', femail='$chng_femail', user_website='$chng_url', user_icq='$chng_user_icq', user_aim='$chng_user_aim', user_yim='$chng_user_yim', user_msnm='$chng_user_msnm', user_from='$chng_user_from', user_occ='$chng_user_occ', user_interests='$chng_user_interests', user_viewemail='$chng_user_viewemail', user_avatar='$chng_avatar', user_sig='$chng_user_sig', user_sig_bbcode_uid='$chng_user_sig_bbcode_uid', user_password='$cpass', newsletter='$chng_newsletter' WHERE user_id='$chng_uid'");
            /*if ($Version_Num > 6.9) {*/ $db->sql_query("UPDATE ".$user_prefix."_users SET points='$chng_points' WHERE user_id='$chng_uid'"); //}
        } else {
            $db->sql_query("UPDATE ".$user_prefix."_users SET username='$chng_uname', name='$chng_name', user_email='$chng_email', femail='$chng_femail', user_website='$chng_url', user_icq='$chng_user_icq', user_aim='$chng_user_aim', user_yim='$chng_user_yim', user_msnm='$chng_user_msnm', user_from='$chng_user_from', user_occ='$chng_user_occ', user_interests='$chng_user_interests', user_viewemail='$chng_user_viewemail', user_avatar='$chng_avatar', user_sig='$chng_user_sig', user_sig_bbcode_uid='$chng_user_sig_bbcode_uid', newsletter='$chng_newsletter' WHERE user_id='$chng_uid'");
            /*if ($Version_Num > 6.9) {*/ $db->sql_query("UPDATE ".$user_prefix."_users SET points='$chng_points' WHERE user_id='$chng_uid'"); //}
        }
