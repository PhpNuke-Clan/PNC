...
if (($radminsuper==1) OR ($radminuser==1)) {
  ...
  echo "<br>\n";
    ...
    echo "<tr><td bgcolor='$bgcolor2'>"._UREALNAME.":</td><td><input type='text' name='chng_realname' value='$chnginfo[realname]' size='40' maxlength='60' style='color=#000000;background-color: #FFFFFF'></td></tr>\n";
    ...
    $chnginfo['time'] = date("D M j H:i T Y", strtotime($chnginfo['time']));
