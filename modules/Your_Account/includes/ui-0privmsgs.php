...
if (!defined('CNBYA')) { echo "CNBYA protection"; exit; }
	...
	echo "<td align=\"left\"><a href=\"modules.php?name=Private_Messages\"><img src=\"$imagedir/whosonline.gif\" style=\"border:none;\"></a></td>";
	echo "<td valign=\"middle\"><a href=\"modules.php?name=Private_Messages\"><b>"._YAPM."&nbsp;: &nbsp;$ya_totpms</b></a><br></td><td width=\"%33\">&nbsp;</td>\n";
	echo "<td><a href=\"modules.php?name=Private_Messages\"><img src=\"$imagedir/msg_inbox.gif\" style=\"border:none;\"></a></td>";
	...
	echo "<td><a href=\"modules.php?name=Private_Messages&file=index&folder=savebox\"><img src=\"$imagedir/msg_savebox.gif\" style=\"border:none;\"></a></td>";
	echo "<td valign=\"middle\"><a href=\"modules.php?name=Private_Messages&file=index&folder=savebox\"><b>&nbsp; "._YASAVED.":&nbsp;$ya_savpms</b></a></td>\n";
	echo "<td width=\"%33\">&nbsp;</td><td><a href=\"modules.php?name=Private_Messages&file=index&folder=outbox\"><img src=\"$imagedir/msg_inbox.gif\" style=\"border:none;\"></a></td>";
