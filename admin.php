...
function GraphicAdmin() {
    ...
    echo "<br>";
        ...
        // START Clan Menu 
    OpenTable();
    echo "<center><a href=\"".$admin_file.".php\"><font class='title'>"._MODULESCLANADMIN."</font></a>";
    echo "<br><br>";
    echo"<table border=\"0\" width=\"100%\" cellspacing=\"1\"><tr>";
    $handle=opendir('modules');
    $modlist = "";
    ...
    for ($i=0; $i < sizeof($modlist); $i++) {
        ...
        while ($row = $db->sql_fetchrow($result)) {
                ...
                if ($radminsuper == 1 OR $auth_user == 1) {
                        if (file_exists("modules/".$row['title']."/admin/index.php") AND file_exists("modules/".$row['title']."/admin/links2.php") AND file_exists("modules/".$row['title']."/admin/case.php")) {
                                include("modules/".$row['title']."/admin/links2.php");
                        }
                }
        }
    echo"</tr></table></center>";
...
function adminMain() {
    global $language, $admin, $aid, $prefix, $file, $db, $sitename, $user_prefix, $admin_file, $bgcolor1;
    include("header.php");
    $dummy = 0;
    $month = date('M');
    ...
    if (!empty($admlanguage)) {
        ...
        OpenTable();
        $v_check = pnc_technology();
        echo "<center><b>"._VCHECKHEADER."</b></center><br>"
                     ."<center>$v_check</center><br>"
    ...
    $who_online = "<center><font class=\"option\"><b>"._WHOSONLINE."</b></font><br><br><font class=\"content\">"._CURRENTLY." $guest_online_num "._GUESTS." $member_online_num "._MEMBERS."<br>";
    ...
    while (list($sid, $aid, $title, $time, $topic, $informant, $alanguage) = $db->sql_fetchrow($result6)) {
                ...
                echo "<tr><td align=\"right\"><b>$sid</b>"
                    ."</td><td align=\"left\" width=\"100%\"><a href=\"modules.php?name=News&amp;op=NEArticle&amp;sid=$sid\">$title</a>"
...
OpenTable();
  ...
  <table width=\"80%\" border=\"0\">
    <tr>
      <td><div align=\"center\"><strong>THE TEAM </strong></div></td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td bgcolor=\"#000000\"><div align=\"left\"><strong><font color=\"#FFFFFF\">Coder and Tester </font></strong></div></td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=718\" target=\"_blank\">XenoMorpH</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Developement and Bugs Fixing</td>
    </tr>
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=7158\"
target=\"_blank\">Palbin</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Developement and Bugs Fixing</td>
    </tr>
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=9411\" target=\"_blank\">Duck</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Developement and Bugs Fixing</td>  
    </tr>
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=12482\" target=\"_blank\">DevXTech</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Tester and Bugs Fixing</td>
    </tr>
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=8253\" target=\"_blank\">KAAIN</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Tester and Bugs Fixing</td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td bgcolor=\"#000000\"><div align=\"left\"><font color=\"#FFFFFF\"><strong>Designer</strong></font></div></td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong><a href=\"http://www.phpnuke-clan.net/modules.php?name=Private_Messages&file=index&mode=post&u=33\" target=\"_blank\">GhostSpirit</a>:</strong></div></td>
      <td width=\"80%\">&nbsp;Lexus-Blue Theme Design Creation</td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td bgcolor=\"#000000\"><div align=\"left\"><font color=\"#FFFFFF\"><strong>The Site Supporter </strong></font></div></td>
    </tr>
  </table>
  <table width=\"80%\" border=\"0\">
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong>VWAR:</strong></div></td>
      <td width=\"80%\">&nbsp;<a href=\"http://www.vwar.de\" target=\"_blank\">http://www.vwar.de</a></td>
    </tr>
    <tr>
      <td width=\"20%\"><div align=\"right\"><strong>SQUERY:</strong></div></td>
      <td width=\"80%\">&nbsp;<a href=\"http://www.squery.com\" target=\"_blank\">http://www.squery.com</a> </td>
    </tr>
  </table>
</div>";
// THE STAFF END
