...
<html>
<head>
<title>PNC 3.0.2 to PNC <?php echo "$pncv"; ?> UPDATE FILE</title></title>
...
/*]]>*/
  ...
  <img src="PNC_logo.png" border="0" alt="" />
    <h2>
      PNC&trade; &copy; 2006, 2007 - PNC3.0.2 to <?php echo "$pncv"; ?> MySQL Table Updater
    </h2>
    <span class="c2">Please note that this installer is for those who update from <u>PNC 3.0.2</u> </span>
    <hr />
    <p class="c1">
        ...
        <td>
			<?php if( !$_SESSION['pnc'] ){ ?>
				<form method="post" action="<?=$_SERVER['PHP_SELF'];?>">
					<b>Step 1&nbsp;&nbsp;-</b> <input class="c1" type="submit" name="submit" value="Update PNC 3.0.2 to PNC<?php echo "$pncv"; ?> Core Tables" />
