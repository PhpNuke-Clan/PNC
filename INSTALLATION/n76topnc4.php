...
<html>
<head>
<title>PHPNuke 7.6 to PNC <?php echo "$pncv"; ?> UPDATE FILE</title></title>
<META NAME="RATING" CONTENT="GENERAL">
<META NAME="GENERATOR" CONTENT="PNC <?php echo $pncv; ?> http://phpnuke-clan.net">
<style type="text/css">
/*<![CDATA[*/
...
/*]]>*/
  ...
  <img src="PNC_logo.png" border="0" alt="" />
    <h2>
      PNC&trade; &copy; 2006, 2007 - PHPNuke 7.6 to <?php echo "$pncv"; ?> MySQL Table Updater
    </h2>
    <span class="c2">Please note that this installer is for those who update from <u>PHPNuke 7.6</u> </span>
    <hr />
    <p class="c1">
        ...
        <td>
			<?php if( !$_SESSION['pnc'] ){ ?>
				<form method="post" action="<?=$_SERVER['PHP_SELF'];?>">
					<b>Step 1&nbsp;&nbsp;-</b> <input class="c1" type="submit" name="submit" value="Update PHPNuke 7.6 to PNC<?php echo "$pncv"; ?>" />
...
<? if ($_GET['setup']) {echo "<br /><span style=\"color:red;font-weight:bold;font-size:14pt;\">You are now ready to proceed to the Setup/Configuration step. Please select <a href=\"setup.php?ready=1\">Setup</a> to proceed to the next setup step.</span><br /><br />";
