...
if(!ereg("^([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})$", $nsnst_const['server_ip'])) { $nsnst_const['server_ip'] = "none"; }
...
function write_ban($banip, $htip, $blocker_row) {
  global $ab_config, $nuke_config, $db, $prefix, $user_prefix, $admin, $nsnst_const;
