...
<p align="center"><img src="abuse/logo.png" width="468" height="60" alt="NukeSentinel(tm)" title="NukeSentinel(tm)" /><br /><strong>You have attempted to enter this site using a proxy.</strong></p>
