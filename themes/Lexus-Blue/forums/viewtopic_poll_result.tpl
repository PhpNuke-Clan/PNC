			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="themes/Lexus-Blue/forums/images/vote_lcap.gif" width="4" alt="" height="12" /></td>
					...
					<td><img src="themes/Lexus-Blue/forums/images/vote_rcap.gif" width="4" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
