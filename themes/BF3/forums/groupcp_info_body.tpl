...
<tr>
<td class="nav"><a href="{U_INDEX}" title="{U_INDEX}">{L_INDEX}</a></td>
</tr>
</table>
...
<tr>
<td class="row2" width="20%">{L_GROUP_NAME}:</td>
<td class="row2" width="80%"><strong>{GROUP_NAME}</strong></td>
</tr>
<tr>
<td class="row2" width="20%">{L_GROUP_DESC}:</td>
<td class="row2">{GROUP_DESC}</td>
</tr>
<tr>
<td class="row2" width="20%">{L_GROUP_MEMBERSHIP}:</td>
...
<tr>
<td class="row2" width="20%">{L_GROUP_TYPE}:</td>
<td class="row2">
...
<tr>
<th colspan="8">{L_GROUP_MODERATOR}</th>
</tr>
<tr>
<td class="row2" align="center">&nbsp;{MOD_PM_IMG}&nbsp;</td>
<td class="row2" align="center"><a href="{U_MOD_VIEWPROFILE}">{MOD_USERNAME}</a></td>
<td class="row2" align="center">{MOD_POSTS}</td>
<td class="row2" align="center">{MOD_FROM}</td>
<td class="row2" align="center">{MOD_EMAIL_IMG}</td>
<td class="row2" align="center">&nbsp;{MOD_WWW_IMG}&nbsp;</td>
<td class="row2" align="center">&nbsp;</td>
</tr>
<tr>
<th colspan="8">{L_GROUP_MEMBERS}</th>
</tr>
<!-- BEGIN member_row -->
<tr>
...
<tr>
<td class="row2" colspan="7" align="center">{L_NO_MEMBERS}</td>
</tr>
<!-- END switch_no_members -->
<!-- BEGIN switch_hidden_group -->
<tr>
<td class="row2" colspan="7" align="center">{L_HIDDEN_MEMBERS}</td>
</tr>
