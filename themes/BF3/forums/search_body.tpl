...
<tr>
<td class="row2" colspan="2" width="50%"><strong>{L_SEARCH_KEYWORDS}:</strong><br />
<span class="gensmall">{L_SEARCH_KEYWORDS_EXPLAIN}</span></td>
<td class="row2" colspan="2"> <input onfocus="this.style.borderColor='#666666'" onblur="this.style.borderColor=''" type="text" style="width: 300px" class="post" name="search_keywords" size="30" />
<br />
...
<tr>
<td class="row2" colspan="2"><strong>{L_SEARCH_AUTHOR}:</strong><br />
<span class="gensmall">{L_SEARCH_AUTHOR_EXPLAIN}</span></td>
<td class="row2" colspan="2">
<input onfocus="this.style.borderColor='#666666'" onblur="this.style.borderColor=''" type="text" style="width: 300px" class="post" name="search_author" size="30" />
</td>
</tr>
<tr>
...
<tr>
<td class="row2" align="right">{L_FORUM}:&nbsp;</td>
<td class="row2">
<select class="post" name="search_forum">{S_FORUM_OPTIONS}</select>
</td>
<td class="row2" align="right" nowrap="nowrap">{L_SEARCH_PREVIOUS}:&nbsp;</td>
<td class="row2">
...
<tr>
<td class="row2" align="right">{L_CATEGORY}:&nbsp;</td>
<td class="row2">
<select class="post" name="search_cat">{S_CATEGORY_OPTIONS}</select>
</td>
<td class="row2" align="right">{L_SORT_BY}:&nbsp;</td>
<td class="row2">
...
<tr>
<td class="row2" align="right" nowrap="nowrap">{L_DISPLAY_RESULTS}:&nbsp;</td>
<td class="row2">
<table border="0" cellspacing="0" cellpadding="0">
<tr>
...
<td class="row2" align="right">{L_RETURN_FIRST}:&nbsp;</td>
<td class="row2">
<table border="0" cellspacing="0" cellpadding="0">
<tr>
