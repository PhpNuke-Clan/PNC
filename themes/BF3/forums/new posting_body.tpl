...
<td class="row2" valign="top"><span class="gen"><span class="row1"></span>
  <table id="posttable" width="100%" border="0" bordercolor="#FFFFFF" style="border-collapse: collapse;" cellspacing="0" cellpadding="0" valign="top">
    <tr align="left" valign="middle"> 
      <td style="width:475px" valign="center">
        <table cellpadding="3" cellspacing="0" style="background-color:#FFFFFF">
          <tr>
            <td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" valign="middle"><img src="modules/Forums/bbcode_box/images/dots.gif" style="padding-left: 4px;"></td>
            <td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);">
            ...
            <td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" align="left"><a href="http://hvmdesign.com/" class="gensmall" title="BBCode Box MOD - by Disturbed One - www.HVMDesign.com" target="blank">BBCode Box v5.1.0</a></td>
          </tr>
          <tr height="28">
            <td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" valign="middle"><img src="modules/Forums/bbcode_box/images/dots.gif" style="padding-left: 4px;"></td>
            <td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" valign="middle" colspan="2">
...
<td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" align="left"></td>
...
<td style="background-image: url(modules/Forums/bbcode_box/images/bg.gif);" align="left"></td>
          ...
          <SCRIPT language=JavaScript src="modules/Forums/color.js"></SCRIPT>
          ...
          <TR>
            <TD colSpan=3>
              <TABLE id=ColorPanel cellSpacing=0 cellPadding=0 align=center border=0>
                <TBODY>
                  <TR>
                    <TD id=ColorUsed onmouseover="helpline('s')" onclick="if(this.style.backgroundColor.length > 0) insertTag(this.style.backgroundColor)" vAlign=center align=middle BORDER-RIGHT: BORDER-TOP: BORDER-LEFT: ridge; CURSOR: default; BORDER-BOTTOM: 2px ridge?>
                      <SCRIPT language=JavaScript>
                        document.write('<IMG height='+height1+' src="modules/Forums/templates/subSilver/images/spacer.gif" width=10 border=1></TD>');
                      </SCRIPT>
                    <TD width=5>
                      <SCRIPT language=JavaScript>
                        document.write('<IMG height='+height1+' src="modules/Forums/templates/subSilver/images/spacer.gif" width=5 border=0></TD>');
                      </SCRIPT>
                    <TD id=ColorUsed1 onmouseover="helpline('s')" onclick="if(this.style.backgroundColor.length > 0) insertTag(this.style.backgroundColor)" vAlign=center align=middle BORDER-RIGHT: BORDER-TOP: BORDER-LEFT: ridge; CURSOR: default; BORDER-BOTTOM: 2px ridge?>
                      <SCRIPT language=JavaScript>
                        document.write('<IMG height='+height1+' src="modules/Forums/templates/subSilver/images/spacer.gif" width=10 border=1></TD>');
                      </SCRIPT>
                    <TD width=5>
...
<input type="text" name="helpbox" size="45" maxlength="100" style="width:450px; font-size:10px" class="helpline" value="{L_STYLES_TIP}" />
		  ...
		  <!-- Canned MOD Begin -->
		  <tr>
			<td colspan="3">{S_CANNED_SELECT}</td>
		  </tr>
		  <!-- Canned MOD End -->
<tr>
<td colspan="3">
