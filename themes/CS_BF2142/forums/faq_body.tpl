<table class="tablefullcenter" cellspacing="2" cellpadding="2">
	<tr>
...
<!-- BEGIN faq_block -->
<table class="forumlinecenter" cellspacing="1" cellpadding="3">
	<tr> 
	...
	<tr>
		<td class="spaceRow1x1"><img src="modules/Forums/images/spacer.gif" alt="image mising spacerGIF" width="1" height="1" /></td>
	</tr>
	<!-- END faq_row -->
</table>
<br clear="all" />
...
<table class="tablefullcenter" cellspacing="2">
	<tr>
