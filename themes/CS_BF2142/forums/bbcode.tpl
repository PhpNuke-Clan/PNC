...
<!-- BEGIN expand_caption_open -->
	<div>
	<div class="expandtitle">
		<input class="expandbtn" type="image" src="images/expand.gif" onClick="javascript:if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.src = 'images/collapse.gif'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.src = 'images/expand.gif'; }" onfocus="this.blur();">&nbsp;<b>{CAPTION}</b>&nbsp;
	</div>
	<div class="expanddiv">
	<div style="display: none;">
<!-- END expand_caption_open -->


<!-- BEGIN expand_open -->
	<div>
		<div class="expandtitle">
			<input class="expandbtn" type="image" src="images/expand.gif" onClick="javascript:if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.src = 'images/collapse.gif'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.src = 'images/expand.gif'; }" onfocus="this.blur();">
		</div>
		<div class="expanddiv">
	<div style="display: none;">
<!-- END expand_open -->
<!-- BEGIN expand_close --></div></div></div><span class="postbody"><!-- END expand_close -->
...
src="{URL}" name=MediaPlayer2 showcontrols=1 showdisplay=0 showstatusbar=1 autosize=1  autostart="0" visible=1 animationatstart=0 transparentatstart=1 loop=0 height=70 width=300> 
</embed> 
</object><!-- END stream -->
...
<OBJECT id="mediaPlayer" width={WIDTH} height={HEIGHT}
		      ...
		      <EMBED type="application/x-mplayer2"
		        ...
		        src="{URL}" autostart="0" designtimesp="5311" loop="0">
		      </EMBED>
      </OBJECT>
<!-- END video -->
